...
<div class="routine-container">
	<div class="header">
		{#if editingTitle}
			...
			<button
				...
				on:click={() => stopEditingTitle(true)}
			...
			>
				<svg
					...
					><path
						...
						stroke-width="2"
						d="M12 19c-2.5-1.5-6-2-9-2V6c3 0 6.5.5 9 2 2.5-1.5 6-2 9-2v11c-3 0-6.5.5-9 2z"
					/></svg
				>
			</button>
		{:else}
	...
	<div class="description-edit">
		{#if editingDescription}
			...
			<button
				...
				on:click={() => stopEditingDescription(true)}
				style="background:none;border:none;cursor:pointer;padding:0 0.5rem;"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
	...
	{#if exercises.length > 0}
		<ol>
			{#each exercises as item, index(item.exercises.name)}
